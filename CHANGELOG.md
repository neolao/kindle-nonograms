...
- The library page's color filter is now more compact (shorter "Mono"/"Multi" labels), and a new status filter lets players show only unsolved, in-progress, or solved puzzles. Both filters, plus the "Recently opened" sort, are now remembered across visits.
...
- Two new puzzles, "Lion" (15×15, four colors) and "Appareil photo" (16×16, four colors).
...
- Pressed/active buttons (the Fill/Cross/Check toolbar buttons and color swatches) no longer jump in size or shift their neighbors' alignment when toggled — their border-width change is now fully absorbed instead of resizing the button.
...
[Unreleased]: https://github.com/neolao/kindle-nonograms/compare/v3.2.1...HEAD
[3.2.1]: https://github.com/neolao/kindle-nonograms/compare/v3.2.0...v3.2.1
[3.2.0]: https://github.com/neolao/kindle-nonograms/compare/v3.1.0...v3.2.0
