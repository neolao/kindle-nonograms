...
## Acceptance Criteria
- [x] When `readPuzzle()` fails, a visible message ("This puzzle couldn't be loaded") appears in the page's chrome panel instead of a silently inert grid.
- [x] The back-link to the library remains usable in this state.
- [x] Existing successful-hydration behavior is unchanged.
