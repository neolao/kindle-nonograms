...
## Acceptance Criteria
- [x] Solving (or otherwise changing) a puzzle's progress in one tab updates another open tab on the same puzzle without a manual reload.
- [x] No regression to single-tab behavior.
