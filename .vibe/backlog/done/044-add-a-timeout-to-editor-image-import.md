...
## Acceptance Criteria
- [x] The image decode is raced against a timeout (e.g. 15 seconds); on timeout, a clear error message is shown ("This image took too long to load").
- [x] The import controls are always re-enabled after a timeout, exactly as after any other decode failure.
- [x] A normal, fast import is unaffected.
