...
## Acceptance Criteria
- [x] Clue-run numbers are rendered with a contrast-safe treatment against their white background, for every palette color.
- [x] The border-style cue that also identifies each color (per decision 003) is unchanged.
- [x] A puzzle with a light palette color (e.g. pale yellow) has legible clue numbers.
