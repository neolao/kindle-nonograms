...
## Acceptance Criteria
- [x] A thrown error during one page module's hydration (library, play, or editor) does not prevent the other two modules from attempting their own hydration.
- [x] A test simulates one module throwing and asserts the others still run.
- [x] No change to normal (non-throwing) hydration behavior on any page.
