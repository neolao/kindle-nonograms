...
## Acceptance Criteria
- [x] `contrastingTextColor` normalizes/expands 3-digit and 8-digit (alpha) hex before computing contrast, instead of falling back to black.
- [x] A dark background in shorthand or alpha hex format now correctly gets white text.
- [x] Existing 6-digit-hex behavior and the malformed-input fallback are unchanged.
