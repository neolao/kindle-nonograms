...
## Acceptance Criteria
- [x] The English string for `play.winBanner.corrected` says the cells were cleared, not fixed/corrected.
- [x] The French string is reworded to match (e.g. "Certaines cases incorrectes ont été effacées, continuez !").
- [x] No other translation key or user-facing behavior changes.
