...
## Acceptance Criteria
- [x] Entering an invalid width or height shows a message in the editor's error region ("Width/height must be a whole number greater than 0") before the field reverts.
- [x] The field still reverts to its previous valid value, as today.
- [x] Entering a valid value clears the error as usual.
