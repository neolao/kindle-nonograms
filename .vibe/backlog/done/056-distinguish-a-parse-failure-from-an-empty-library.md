...
## Acceptance Criteria
- [x] A parse failure of the embedded puzzles data logs a warning (console), distinguishable from the genuinely-empty-library case.
- [x] The genuinely-empty-library case (an actual `[]`) is unaffected.
