...
## Acceptance Criteria
- [x] The GitHub contribution link has visually-hidden text stating it opens in a new tab (same `.sr-only` pattern already used for the back-link).
- [x] The visible arrow glyph is unchanged.
