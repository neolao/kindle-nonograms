...
## Acceptance Criteria
- [x] After a successful export, the page shows a brief confirmation (e.g. "Exported `<filename>.json` — download started.").
- [x] The confirmation appears in a location consistent with the rest of the editor's feedback conventions.
- [x] A failed export still shows its existing error message instead of a confirmation.
