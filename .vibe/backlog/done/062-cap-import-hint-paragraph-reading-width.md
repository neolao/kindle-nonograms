...
## Acceptance Criteria
- [x] The Import hint paragraph (and similar reading-text paragraphs, if applicable) is capped at roughly 60–70 characters per line on wide viewports.
- [x] No change on narrow (Kindle-width) viewports, where the line already wraps naturally.
