...
## Acceptance Criteria
- [ ] New workflow `.github/workflows/pr-check.yml` triggers on `pull_request` (opened/synchronize/reopened) targeting `main`.
